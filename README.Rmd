...
TMSig). You must set the correct Bioconductor version for your
...
(>= 1.9.0), which is not on CRAN or Bioconductor. `DESCRIPTION` declares it in
...
MotrpacBicQC imports `inspectdf`, which was archived on CRAN in April 2026. If
installation stops with an error about `inspectdf`, install it from the CRAN
archive and retry:
