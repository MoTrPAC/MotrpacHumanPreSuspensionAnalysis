...
The package version names the data collection it is built on. In a
version such as 2.0.8, the first two digits are the MoTrPAC data
collection (2.0 is c2.0) and the last digit counts package updates made
on top of that collection. A new data collection starts a new version
series.

- **Version 0.2.0** generated the figures in the initial bioRxiv
  pre-print. It predates the c2.0 collection, so install it to reproduce
  those figures exactly.
- **The 2.0.x series** is built on c2.0 and, together with the other
  packages listed below, is the basis of the forthcoming pre-print.

Over the course of peer review and additional analysis, modifications
may occur. Each release is listed in the GitHub “Releases” section.
...
also write PDFs with
[`cairo_pdf()`](https://rdrr.io/r/grDevices/cairo.html), which needs
XQuartz on macOS.
...
[submit a new
issue](https://github.com/MoTrPAC/MotrpacHumanPreSuspensionAnalysis/issues)
...
Or if you enter in a wrong mistaken tissue/ome, a warning or error will
help.
...
Available options can be queried via
[`tissue_available_list()`](https://motrpac.github.io/MotrpacHumanPreSuspensionAnalysis/reference/tissue_available_list.md)
and
[`ome_available_list()`](https://motrpac.github.io/MotrpacHumanPreSuspensionAnalysis/reference/ome_available_list.md).
If an invalid tissue or assay is supplied, informative warnings or
errors are raised to guide correction.
...
- Data used in the preparation of this article were obtained from the
  ...
  [motrpac-data.org](https://motrpac.github.io/MotrpacHumanPreSuspensionAnalysis/motrpac-data.org).
- Data used in the preparation of this article were obtained from the
  Molecular Transducers of Physical Activity Consortium (MoTrPAC)
  Pre-CovidSuspension Data release version c2.0.
