...
`plot_enrich_heatmap()` creates bubble heatmaps from CAMERA-PR or
PTM-SEA results, showing enrichment z-scores with significance bubbles.
...
`run_cmeans()` performs fuzzy c-means (FCM) clustering on z-score
matrices from differential analysis, grouping features with similar
