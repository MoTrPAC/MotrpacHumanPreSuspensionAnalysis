#' @title Pre-specified transcription Factors from the UToronto dataset
#'
#' @description This page contains the official list of human TFs
#' from Lambert et al (PMID:29425488), along with all associated information.
...
#'
#'
#' @format https://humantfs.ccbr.utoronto.ca/download.php
#'
#' @keywords dataset
"UTORONTO_TFs"
